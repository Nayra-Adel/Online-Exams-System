...
<html>
    ...
    <body>
      <form name="ExamForm" action="setExam">
            ...
            <form name="questionform" action="sendCandidateAnswer">
                <h3 id="username" > question <%=i%> : <br><h4><%= q.sentence%></h4></h3>

                <input type="text" name="questionID" value="<%= q.question_id%>" style="display: none;"><br>
                ...
                <input type="submit" value="skip" id="<%= q.question_id %>" onclick="skipQuestion(this)"><br>
                <input type="submit" value="Submit Answer" id="<%= q.question_id%>"><br>
